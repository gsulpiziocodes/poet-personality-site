  ...
  <section class='analysis-zone'>
    <div class='analysis-top'>
      ...
      <div class='analysis-actions'>
        <button class='btn primary analysis-action-btn is-primary' id='analyzePoemsBtn' type='button'>Analyze</button>
        <button class='btn secondary analysis-action-btn is-secondary' id='deepAnalyzePoemsBtn' type='button'>Deep Analysis</button>
      </div>
    </div>
    <div class='analysis-poem-deep-row'>
      <select id='deepPoemSelect' class='analysis-select' aria-label='Choose poem for deep analysis'></select>
...
const POET_COACH_BY_SLUG={
  'the-alchemist':{name:'The Alchemist',first:"I'm The Alchemist. Start with what broke, and we'll turn it into what changed.",tips:['Turn one object into a symbol of transformation.','Move from wound to wisdom by line 6.','Use fire, water, or metal imagery to anchor the poem.']},
  'the-oracle':{name:'The Oracle',first:"I'm The Oracle. Give me one sign, omen, or strange detail from today, and we'll decode it into a poem.",tips:['Write in short visionary fragments.','Ask one haunting question in the middle.','End with an image that feels fated.']},
  'the-architect':{name:'The Architect',first:"I'm The Architect. Bring me one scene, and we'll build the poem with clean structure and sharp turns.",tips:['Keep one central image in every stanza.','Trim soft filler words after your first draft.','Use line breaks to control emphasis.']},
  'the-seeker':{name:'The Seeker',first:"I'm The Seeker. Start with the question you can't shake, and we'll follow it to the edge.",tips:['Let curiosity drive each stanza.','Use one concrete detail from your room.','End open, not solved.']},
  'the-lover':{name:'The Lover',first:"I'm The Lover. Give me one intimate moment—touch, distance, ache—and we'll make it unforgettable.",tips:['Make emotion physical, not abstract.','Use closeness and distance as tension.','End with a line that aches softly.']},
  'the-dreamer':{name:'The Dreamer',first:"I'm The Dreamer. Start with a glowing image, then anchor it with one real-world detail.",tips:['Let transitions feel soft and fluid.','Use moon, light, or mist imagery with restraint.','Close like waking up slowly.']},
  'the-muse':{name:'The Muse',first:"I'm The Muse. Drop your most magnetic opening line, and we'll shape the rhythm around it.",tips:['Read aloud and tune by ear.','Repeat one phrase with variation.','Prioritize image and cadence over explanation.']},
  'the-devotee':{name:'The Devotee',first:"I'm The Devotee. Tell me who or what you're honoring, and we'll write with reverence and precision.",tips:['Let sincerity lead the language.','Name one ritual and why it matters.','End with a vow or promise.']},
  'the-confessor':{name:'The Confessor',first:"I'm The Confessor. Start with the line you'd usually keep to yourself, and we'll write it true.",tips:['First stanza: no metaphor, just truth.','Name body sensations while writing.','Revise for honesty, not polish first.']},
  'the-witness':{name:'The Witness',first:"I'm The Witness. Tell me exactly what you see right now, and we'll let detail carry the feeling.",tips:['Use sensory detail from the scene.','Trust observation to carry feeling.','Keep diction clear and grounded.']},
  'the-rebel':{name:'The Rebel',first:"I'm The Rebel. Name what you're done accepting, and we'll turn that friction into force.",tips:['Use active verbs in each line.','Break one rule on purpose.','Turn anger into clarity.']},
  'the-mourner':{name:'The Mourner',first:"I'm The Mourner. Begin with what feels absent, and we'll hold it with tenderness and restraint.",tips:['Say less and let silence work.','Use gentle domestic details.','End with one line of tenderness.']},
  'the-storyteller':{name:'The Storyteller',first:"I'm The Storyteller. Start in the middle of the moment, and we'll shape the arc around what changed.",tips:['Build before and after movement.','Carry one object through the narrative.','Final line reveals what changed.']},
  'the-minimalist':{name:'The Minimalist',first:"I'm The Minimalist. Give me 3-5 clean lines, and we'll cut to the exact emotional hit.",tips:['Cut anything non-essential.','One image per line is enough.','Keep ending plain and sharp.']},
  'the-performer':{name:'The Performer',first:"I'm The Performer. Write it like you're saying it to someone in the front row.",tips:['Use repetition for momentum.','Read aloud and revise by sound.','End with your strongest spoken line.']},
  'the-weaver':{name:'The Weaver',first:"I'm The Weaver. Bring me two threads—memory, image, idea—and we'll braid them into one living piece.",tips:['Alternate threads by stanza.','Repeat an image to stitch layers.','Let both threads meet at the end.']}
};
